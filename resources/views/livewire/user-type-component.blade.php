            ...
            <div class="flex flex-row justify-between mb-4 py-4">
                <div class="flex w-3/6">
                    <select class="w-3/6 rounded-l-lg focus:border-sky-400 border-t mr-0 border-b border-1 text-gray-800 bg-white px-3 py-2 pr-8 focus:outline-none" wire:model.live="buscapor">
                        <option class="hover:bg-pink-400" value="dni">Nombre</option>
                    </select>
                                ...
                                @foreach ($user_types as $user_type)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center mb-8">
                                            <button class="text-blue-600 hover:text-blue-900 focus:outline-none" wire:click="edit({{$user_type->id}})">
                                            ...
                                            <button class="text-red-600 hover:text-red-900 focus:outline-none" wire:click="destroy({{$user_type->id}})">
                                                <!-- Add your edit icon here, e.g., Edit Icon from Tailwind -->
         ...
         <div class="bg-gray-800 bg-opacity-25 fixed inset-0">
             <div class="py-12 fixed inset-0 z-10 overflow-y-auto">
                 <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 w-auto">
                     <div class="bg-white shadow text-left rounded-lg p-6 sm:w-2/6">
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 w-auto">
                    <div class="bg-white shadow text-left rounded-lg p-6 sm:w-2/6">
                        <form wire:submit="update" class="w-full">
                            <div class="mb-4">
                                <label for="create-name">Nombre</label>
                                <input type="text" id="create-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" wire:model="user_type_edit.ediname">
                                {{-- modifique el input-error --}}
                                <x-errores :messages="$errors->get('user_type_edit.ediname')" />
                            </div>
                            <div></div>
